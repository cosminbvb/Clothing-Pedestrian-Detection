# Source: https://github.com/switchablenorms/DeepFashion2/blob/master/evaluation/deepfashion2_to_coco.py
...
num_images = 191962  # (train)

sub_index = 0 # the index of ground truth instance
for num in range(1, num_images):
    # json_name = 'Datasets/Deepfashion2/validation/annos/' + str(num).zfill(6)+'.json'
    # image_name = 'Datasets/Deepfashion2/validation/image/' + str(num).zfill(6)+'.jpg'
...
# json_name = 'Datasets/Deepfashion2/valid.json'
json_name = 'Datasets/Deepfashion2/train.json'
